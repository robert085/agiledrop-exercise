...
var body = document.querySelector("body"),
  ...
  e.matches ? (btnDrupal.after(drupal), btnVue.after(vue), btnLaraver.after(laraver)) : (techNav.after(drupal), techNav.after(vue), techNav.after(laraver));
    ...
    slider = (condition(maxWidth), maxWidth.onchange = function (e) {
  condition(e);
}, function () {
  var e = document.querySelectorAll(".slide"),
      t = document.querySelectorAll(".pagination__circle");
  var o = 0;

  var c = function c() {
    t.forEach(function (e) {
      e.classList.remove("pagination__circle--active"), document.querySelector(".circle-" + (o + 1)).classList.add("pagination__circle--active");
    });
  };

  setInterval(function () {
    o < e.length - 1 ? (o++, console.log(o), e.forEach(function (e) {
      e.style.transform = "translateX(-".concat(100 * o, "%)");
    }), c()) : (o = 0, c(), e.forEach(function (e) {
      e.style.transform = "translateX(".concat(100 * o, "%)");
    }));
  }, 3e3);
});
