...
var body = document.querySelector("body"),
  ...
  var o = document.querySelectorAll(".slide");
  var n = 0;
  o.forEach(function (e, t) {
    setTimeout(function () {
      ++n <= o.length - 1 ? o.forEach(function (e) {
        e.style.transform = "translateX(-".concat(100 * n, "%)"), console.log(n);
      }) : (n = 0, o.forEach(function (e) {
        e.style.transform = "translateX(".concat(100 * n, "%)");
      }));
    }, 2e3 * (t + 1));
  });
});
